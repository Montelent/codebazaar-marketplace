    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Static CMS pages · Terms, Privacy, About, Help…</p>
        </div>
        <Link href="/admin/pages/new"><Button><Plus className="h-4 w-4" /> Add page</Button></Link>
      </div>
